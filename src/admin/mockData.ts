...
export function getMockRecentActivity(): AdminActivityRow[] {
  return [
    ...
    { id: 'a3', type: 'payment', title: 'Payment received — £34.00', subtitle: 'Taylor Williams · Multi-site Business', createdAt: daysAgo(1) },
...
export function getMockPayments(): AdminPaymentRow[] {
  return MOCK_USERS.filter((u) => u.subscriptionStatus === 'active' || u.subscriptionStatus === 'past_due')
    ...
    .map((u, i) => ({
      ...
      amountCents: u.subscriptionTier === 'solo' ? 2400 : u.subscriptionTier === 'multi' ? 3400 : 4400,
      currency: 'gbp',
