...
export const WIDGET_HELP = {
  ...
  expectedReceipts:
    'Money you expect to receive. Set Start (when it begins affecting Available) and Expected (when cash should arrive). Lump sum counts the full amount from Start; Build up accrues daily from Start to Expected. A new row with no Start does not change your balance until you set one — useful for future lump sums you want to backdate. When the actual amount differs from your estimate, edit the amount and history for that period is corrected automatically.',
  reservePlanner:
