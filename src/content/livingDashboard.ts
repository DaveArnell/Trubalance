...
export const WIDGET_HELP = {
  ...
  expectedReceipts:
    'Money you expect to receive.\n\nSet the Expected date for when cash should arrive. You can count the full amount toward your position straight away, or build it up day by day to the Expected date.\n\nIf only part arrives, use Received and enter how much you got — the rest stays expected and past Trends are left alone. Entering more than expected marks it fully received and can correct history from when the receipt started.',
  reservePlanner:
