  ...
  calendar: {
    ...
    steps: [
      ...
      },
      {
        ...
        title: 'Coming up',
        body: 'A separate list of what’s next, in date order.\n\nOptional: Show reserve transfers if you want monthly reserve moves on the 1st in this list too.',
        placement: 'left',
        page: 'calendar',
      },
    ],
