/** Frontend mirror of product email copy for admin preview. Keep in sync with supabase/functions/_shared/productEmail.ts */
...
const SITE_URL = 'https://www.cashprophet.co.uk'
